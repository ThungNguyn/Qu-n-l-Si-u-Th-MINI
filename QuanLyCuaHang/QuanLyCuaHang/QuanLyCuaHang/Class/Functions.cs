...
namespace QuanLyCuaHang.Class
{
    internal class Functions
    {
        ...
        public static void Connect()
        {
            ...
            con.ConnectionString = "User Id=test;Password=123;Data Source=TranDinhBien:1521/orcl21";
        ...
        public static DataTable GetDataTable(string str)
        {
            ...
            OracleDataAdapter adt = new OracleDataAdapter(str, con);
            adt.Fill(dt);
            return dt;
        }
        ...
        public static bool CheckKey(string str)
        {
            ...
            OracleDataAdapter ad = new OracleDataAdapter(str, con);
